...
export function ExportBar(): JSX.Element {
  ...
  return (
    <div className="mt-4 flex items-center gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900">
      <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Export Results:</span>
      <button
